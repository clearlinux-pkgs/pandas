...
Source0  : https://github.com/pandas-dev/pandas/releases/download/v2.2.3/pandas-2.2.3.tar.gz
...
%prep
%setup -q -n pandas-2.2.3
cd %{_builddir}/pandas-2.2.3
pushd ..
cp -a pandas-2.2.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726842500
